...
Для развертывания на production сервере используйте специальную конфигурацию:
...
📖 **[Полное руководство по развертыванию](docs/guides/manual-deploy.md)**
...
- **Безопасность:** PostgreSQL без внешнего доступа
- **Restart policies:** автоматический перезапуск сервисов
