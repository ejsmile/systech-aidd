...
|---|----------|--------|--------------|-----------------|
| 1.1 | Функциональные требования к дашборду | ⏳ Ожидает | - | - |
| 1.2 | Проектирование API контракта | ⏳ Ожидает | - | - |
| 1.3 | Проектирование StatCollector интерфейса | ⏳ Ожидает | - | - |
| 1.4 | Mock реализация StatCollector | ⏳ Ожидает | - | - |
| 1.5 | API entrypoint и интеграция | ⏳ Ожидает | - | - |
| 2.1 | Frontend концепция и требования | ⏳ Ожидает | - | - |
| 2.2 | Выбор технологического стека | ⏳ Ожидает | - | - |
| 2.3 | Структура проекта и инструменты | ⏳ Ожидает | - | - |
